...
import 'package:faceauthml_main/pages/widgets/FacePainter.dart';
import 'package:faceauthml_main/pages/widgets/auth-action-button.dart';
  ...
  Future<bool> onShot() async {
    if (faceDetected == null) {
      showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            content: Text('Rostro no detectado!'),
          );
        },
      );
